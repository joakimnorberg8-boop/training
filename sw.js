...
self.addEventListener('fetch',event=>{
  ...
  const fresh=event.request.mode==='navigate'||['script','style','worker'].includes(event.request.destination);
